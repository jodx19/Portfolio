...
function Skills({ skills }) {
  ...
  // Map skill translation keys by index
  const skillKeys = [
      ...
      >
        ...
        <motion.div className="mb-12 text-center" variants={fadeUp}>
          ...
          <h2 className="text-4xl md:text-5xl font-bold text-txt-primary mt-3 tracking-tight">
            {t("skills.title")} <span className="text-cyan-400">{t("skills.titleHighlight")}</span>
          </h2>
        </motion.div>
        ...
        >
          {skills.map((skill, index) => {
            ...
            const level = skill.level === "Expert" ? t("skills.levelExpert") : t("skills.levelAdvanced");
